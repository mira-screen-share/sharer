...
impl WebSocketSignaller {
    pub async fn new(url: &str) -> Result<Self> {
        let (sdp_answer_sender, sdp_answer_receiver) =
            tokio::sync::mpsc::channel::<RTCSessionDescription>(1);
        ...
        let (send_queue_sender, mut send_queue_receiver) =
            tokio::sync::mpsc::channel::<SignallerMessage>(8);
    ...
    pub async fn send_ice(ice: &RTCIceCandidate, sender: &mut Sender<SignallerMessage>) {
